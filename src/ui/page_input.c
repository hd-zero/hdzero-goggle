...
// const char *btnOptions[] = {_("toggle_osd"), _("main_menu"), _("toggle_OSD"), _("center_ht"), _("calibrate_ht"), _("go_sleep"), _("toggle_fan_sleep"), _("start_dvr")};
...
// const char *rollerOptions[] = {_("switch_channel"), _("change_fan_speed"), _("oled_brightness")};
