...
static lv_i18n_phrase_t ru_ru_singulars[] = {
    ...
    {"power", "Питание"},
    {"battery", "Аккумулятор"},
    {"cell_count_mode", "Режим подсчета ячеек"},
    {"auto", "Авто"},
    {"manual", "Ручной"},
    {"cell_count", "Кол-во ячеек"},
    {"warning_cell_voltage", "Предупреждение о напряжении ячейки"},
    ...
    {"mic", "Микрофон"},
    {"line_in", "Линейный вход"},
    {"a/v_in", "A/V вход"},
    {"naming_scheme", "Схема именования"},
    {"digits", "Цифры"},
    {"date", "Дата"},
    ...
    {"analog_video", "Аналоговое видео"},
    {"hdzero_band", "HDZero диапазон"},
    {"raceband", "Raceband"},
    {"lowband", "Lowband"},
    {"hdzero_bw", "HDZero BW"},
    {"wide", "Широкий"},
    ...
    {"roller", "Колесо"},
    {"left_short", "Короткое лево"},
    {"left_long", "Длинное лево"},
    {"right_short", "Короткое право"},
    {"right_long", "Длинное право"},
    {"right_double", "Двойное вправо"},
    {"osd", "OSD"},
    {"scannow", "Сканировать"},
    {"wifi", "WiFi"},
    {NULL, NULL} // End mark
