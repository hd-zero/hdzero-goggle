...
static int iic_open(char* port)
{
    ...
    if(i2c_fd <0) {
        Printf("iic_open %s failed [1=Right,2=Main,3=Left]\n",port);
    }
    return i2c_fd;
}
