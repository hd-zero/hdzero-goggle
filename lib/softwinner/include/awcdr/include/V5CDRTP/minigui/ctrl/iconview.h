...
MG_EXPORT int iconview_set_item_bitmap(HWND hWnd, GHANDLE pivdata, int nItem, GHANDLE bmp);

MG_EXPORT int iconview_set_item_icon(HWND hWnd, GHANDLE pivdata, int nItem_ex, GHANDLE bmp);
