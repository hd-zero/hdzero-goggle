...
//add by habo 2019.03.27
/** Column image or icon left align, default */
#define LVCF_LEFTALIGN_IMAGE 0x0000
/** Column image or icon right align, default */
#define LVCF_RIGHTALIGN_IMAGE 0x0001
/** Column image or icon center align, default */
#define LVCF_CENTERALIGN_IMAGE 0x0002
...
typedef struct _LVCOLUMN
{
    ...
    DWORD colFlags;
    /** Column image or icon align flags */
    DWORD colmFlags;
} LVCOLUMN;
